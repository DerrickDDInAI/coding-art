...
usage: python spectrographic.py --image ./source.png --min_freq 10000 --max_freq 20000 --duration 10 --save sound.wav --play
source: https://github.com/LeviBorodenko/spectrographic
